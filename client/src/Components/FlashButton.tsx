...
export default function Button({children, className, backgroundColor}: Readonly<{
  ...
  return (
    <div className={className || ""}>
        <button className={`group relative px-8 py-4 ${backgroundColor || " bg-[#00ff41]"} text-[#0A0A0A] font-bold text-lg overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,65,0.5)]`}>
